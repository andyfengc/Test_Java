...
public class ScatterChartSample extends Application {
	...
	public void start(Stage stage) {
		...
		addListener(add, sc, remove);
	}

	private void addListener(Button add, ScatterChart<Number, Number> sc, Button remove) {
		add.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent e) {
				...
				for (int i = 0; i < 100; i++)
					series.getData().add(
							new ScatterChart.Data<Number, Number>(Math.random() * 100, Math.random() * 500));
