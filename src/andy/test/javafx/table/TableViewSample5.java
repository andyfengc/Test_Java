...
/**
 * refine the behaviour when user modify the cell value and press enter key
 * extends TableViewSample4
 */
...
public class TableViewSample5 extends Application {
	...
	public void start(Stage stage) {
		...
		// redefine the TextField behavior to commit the edit on the focus
		// change when press enter, default is modify cell value when press
		// enter key
